...
class mopac_run:
    ...
    def obtain_mol3d(self,geopath,mol_geopath):
        this_mol = mol3D()
        this_mol.readfromxyz(geopath + '/' + self.name.lower() + '.xyz')
...
targetpaths=sorted(glob.glob("solpm7/outfiles/*.out"))
mol_geopath = "/home/jp/Dropbox/Main/optimal_mol_des/automated_search_one/keep/molpac"
geopath ="/home/jp/Dropbox/Main/optimal_mol_des/automated_search_one/keep/sobs/solpm7/optimized_geo"
