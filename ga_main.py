...
class tree_generation:
        ...
        def assess_fitness(self):
            ...
            fitness_values  = dict()
            print('self status keys',self.status_dictionary["ready_to_advance"])
        ...
        def job_dispatcher(self):
                ...
                for keys in self.outstanding_jobs.keys():
                        ...
                        for spins in [2,6]:
                                ...
                                ## generate HS/LS
                                this_jobname = jobs.generate_geometery(prefix = job_prefix, spin = spins,path_dictionary = self.current_path_dictionary,
